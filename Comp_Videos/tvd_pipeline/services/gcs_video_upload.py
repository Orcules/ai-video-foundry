"""GCS Video Upload service for final video uploads."""
...
class GCSVideoUploadService:
    ...
    def _initialize(self) -> bool:
        ...
        try:
            ...
            logger.warning(f"Failed to initialize GCS Video Upload: {e}")
            return False
    ...
    def upload_product_reference(
        ...
        _config = Config()
        folder = folder or _config.PRODUCT_REFERENCE_FOLDER
        ...
        try:
            ...
            logger.info("[PRODUCT] Uploading reference frame to GCS...")
            ...
            try:
                ...
                logger.info("[PRODUCT] ACL not supported, using direct URL")
